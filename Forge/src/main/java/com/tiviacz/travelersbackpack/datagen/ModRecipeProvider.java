...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> writer) {
        ...
        //Warden
        ShapedBackpackRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.WARDEN_TRAVELERS_BACKPACK.get())
    ...
    protected static void colorBlockWithDye(Consumer<FinishedRecipe> recipeOutput, List<Item> pDyes, List<Item> pDyeableItems, String pGroup) {
