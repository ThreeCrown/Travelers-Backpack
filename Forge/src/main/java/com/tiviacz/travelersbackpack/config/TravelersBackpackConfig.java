...
public class TravelersBackpackConfig {
    public static class Server {
        ...
        public static class BackpackSettings {
            ...
            BackpackSettings(ForgeConfigSpec.Builder builder, String path) {
                ...
                //Backpack Settings
                                leather = new BackpackSettings.TierConfig(builder, "Leather", 5, 0, 0);
                                iron = new BackpackSettings.TierConfig(builder, "Iron", 10, 0, 2);
                                gold = new BackpackSettings.TierConfig(builder, "Gold", 15, 0, 3);
                                diamond = new BackpackSettings.TierConfig(builder, "Diamond", 20, 0, 4);
                                netherite = new BackpackSettings.TierConfig(builder, "Netherite", 27, 0, 6);
            ...
            public static class TierConfig {
                ...
                public final ForgeConfigSpec.IntValue toolSlotCount;
                                ...
                                public TierConfig(ForgeConfigSpec.Builder builder, String tier, int inventorySlotCountDefault, int upgradeSlotCountDefault, int toolSlotCountDefault) {
            ...
            public record Tier(int inventorySlotCount, int toolSlotCount) {
            }
        }
        ...
        public static class World {
            ...
            World(ForgeConfigSpec.Builder builder, String path) {
                ...
                spawnEntitiesWithBackpack = builder
                        ...
                        .define("spawnEntitiesWithBackpack", false);
    ...
    public static class Client {
        ...
        public static class ToolsOverlay {
            public final ForgeConfigSpec.BooleanValue swapOnClose;
            public final ForgeConfigSpec.BooleanValue showTooltip;
            public final ForgeConfigSpec.BooleanValue renderBackpackIconInCenter;
