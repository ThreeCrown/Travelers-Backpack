...
public record ServerboundActionTagPacket(CompoundTag actionTag) {
    ...
    public static final int SWAP_TOOL = 5;
    public static final int TOGGLE_BUTTONS_VISIBILITY = 6;
    public static final int SHOW_TOOL_SLOTS = 7;
    public static final int REMOVE_UPGRADE = 8;
    public static final int OPEN_SETTINGS = 9;
    public static final int TOGGLE_VISIBILITY = 10;
    public static final int ABILITY_SLIDER = 11;
    public static final int EQUIP_BACKPACK = 12;
    public static final int SET_STACK = 13;
