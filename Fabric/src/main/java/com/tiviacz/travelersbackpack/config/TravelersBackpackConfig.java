    ...
    public static class Server {
        ...
        public static class BackpackSettings {
            ...
            BackpackSettings(ModConfigSpec.Builder builder, String path) {
                ...
                //Backpack Settings
                leather = new TierConfig(builder, "Leather", 5, 0, 0, (int)FluidConstants.BUCKET);
                iron = new TierConfig(builder, "Iron", 10, 0, 2, (int)FluidConstants.BUCKET);
                gold = new TierConfig(builder, "Gold", 15, 0, 3, (int)FluidConstants.BUCKET);
                diamond = new TierConfig(builder, "Diamond", 20, 0, 4, (int)FluidConstants.BUCKET);
                netherite = new TierConfig(builder, "Netherite", 27, 0, 6, (int)FluidConstants.BUCKET);
