...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    protected RecipeProvider createRecipeProvider(HolderLookup.Provider registries, RecipeOutput writer) {
        return new RecipeProvider(registries, writer) {
            @Override
            public void buildRecipes() {
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.STANDARD_TRAVELERS_BACKPACK).group("standard_travelers_backpack")
                        ...
                        .unlockedBy("has_chest", has(ConventionalItemTags.WOODEN_CHESTS))
                        .save(writer, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(TravelersBackpack.MODID, "standard")));
                ...
                SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE),
                        ...
                        .save(writer, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(TravelersBackpack.MODID, "netherite")));
                ...
                createBackpackSmallGrid(ModItems.EMERALD_TRAVELERS_BACKPACK, ofTag(ConventionalItemTags.EMERALD_GEMS), getHasName(Items.EMERALD), has(ConventionalItemTags.EMERALD_GEMS)).save(writer);
                createBackpackSmallGrid(ModItems.IRON_TRAVELERS_BACKPACK, ofTag(ConventionalItemTags.IRON_INGOTS), getHasName(Items.IRON_INGOT), has(ConventionalItemTags.IRON_INGOTS)).save(writer);

                createBackpackSmallGrid(ModItems.ENDERMAN_TRAVELERS_BACKPACK, ofTag(ConventionalItemTags.ENDER_PEARLS), getHasName(Items.ENDER_PEARL), has(ConventionalItemTags.ENDER_PEARLS)).save(writer);
                ...
                createBackpackFullGrid(ModItems.REDSTONE_TRAVELERS_BACKPACK, ofTag(ConventionalItemTags.REDSTONE_DUSTS), getHasName(Items.REDSTONE), has(ConventionalItemTags.REDSTONE_DUSTS)).save(writer);
                createBackpackFullGrid(ModItems.COAL_TRAVELERS_BACKPACK, ofTag(ItemTags.COALS), getHasName(Items.COAL), has(ItemTags.COALS)).save(writer);
                ...
                createBackpackFullGrid(ModItems.HAY_TRAVELERS_BACKPACK, ofTag(ConventionalItemTags.WHEAT_CROPS), getHasName(Items.WHEAT), has(ConventionalItemTags.WHEAT_CROPS)).save(writer);

                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.BEE_TRAVELERS_BACKPACK)
                        .define('A', Items.HONEYCOMB).define('B', Items.HONEY_BOTTLE).define('C', ModItems.STANDARD_TRAVELERS_BACKPACK)
                        .pattern("ABA").pattern("BCB").pattern("ABA")
                        .unlockedBy(getHasName(Items.HONEYCOMB), has(Items.HONEYCOMB))
                        .unlockedBy(getHasName(Items.HONEY_BOTTLE), has(Items.HONEY_BOTTLE)).save(writer);

                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.BLAZE_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.BOOKSHELF_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.CACTUS_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.COW_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.CREEPER_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.DRAGON_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.END_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.GHAST_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.HORSE_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.LAPIS_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.MAGMA_CUBE_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.MELON_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.NETHER_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.PIG_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.PUMPKIN_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.QUARTZ_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.SANDSTONE_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.SNOW_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.SPIDER_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.SQUID_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.WITHER_TRAVELERS_BACKPACK)
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.WARDEN_TRAVELERS_BACKPACK)
                ...
                List<Item> sleepingBags = List.of(ModItems.BLACK_SLEEPING_BAG, ModItems.BLUE_SLEEPING_BAG, ModItems.BROWN_SLEEPING_BAG, ModItems.CYAN_SLEEPING_BAG, ModItems.GRAY_SLEEPING_BAG, ModItems.GREEN_SLEEPING_BAG, ModItems.LIGHT_BLUE_SLEEPING_BAG, ModItems.LIGHT_GRAY_SLEEPING_BAG, ModItems.LIME_SLEEPING_BAG, ModItems.MAGENTA_SLEEPING_BAG, ModItems.ORANGE_SLEEPING_BAG, ModItems.PINK_SLEEPING_BAG, ModItems.PURPLE_SLEEPING_BAG, ModItems.RED_SLEEPING_BAG, ModItems.YELLOW_SLEEPING_BAG, ModItems.WHITE_SLEEPING_BAG);
                colorWithDye(writer, dyes, sleepingBags, null, "sleeping_bag");
            ...
            private void sleepingBagFromWool(RecipeOutput recipeOutput, ItemLike sleepingBag, ItemLike wool) {
                ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.DECORATIONS, sleepingBag)
                        .group("sleeping_bag")
                        .define('#', wool)
            ...
            private void colorWithDye(RecipeOutput output, List<Item> dyes, List<Item> dyeableItems, Item dye, String group) {
                for(int i = 0; i < dyes.size(); i++) {
                    ...
                    Stream<Item> stream = dyeableItems.stream().filter(candidate -> !candidate.equals(dyedItem));
                    if(dye != null) {
                        stream = Stream.concat(stream, Stream.of(dye));
                    }

                    ShapelessRecipeBuilder.shapeless(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.BUILDING_BLOCKS, dyedItem)
                            .requires(item)
                            .requires(Ingredient.of(stream))
                            .group(group)
                            .unlockedBy("has_needed_dye", this.has(item))
                            .save(output, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(TravelersBackpack.MODID, "dye_" + getItemName(dyedItem))));
                }
            }
